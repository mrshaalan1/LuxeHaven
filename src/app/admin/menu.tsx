...
const FormDisabledDemo: React.FC = () => {
  ...
  return (
    ...
    <div className="pt-10 pb-32">
      ...
      <h1 className="text-4xl flex justify-center items-center font-bold py-5 pb-5 ">Add New Dish</h1>
        <Form layout="horizontal" className="w-5/6 text-xl pt-10">
          ...
          <div className="py-3 text-2xl">
            <label className="text-zinc-100" style={{fontSize: 26}}>Dish name</label>
            <Input className="text-xl" />
          </div>
          <div className="py-3 text-2xl">
            <label className="text-zinc-100" style={{fontSize: 26}}>Dish Description</label>
            <Input className="text-xl" />
          </div>
          <div className="py-3 text-2xl">
            <label className="text-zinc-100" style={{fontSize: 26}}>Dish Brand</label>
            <Input className="text-xl" />
          </div>
          <div className="py-3 text-2xl">
            <label className="text-zinc-100" style={{fontSize: 26}}>Dish Price</label>
            <Input className="text-xl" />
          </div>
